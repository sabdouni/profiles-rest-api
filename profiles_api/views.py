...
class UserProfilViewSet(ModelViewSet):
    ...
    serializer_class: ModelSerializer = serializers.UserProfilSerializer
    queryset: QuerySet = models.UserProfil.objects.all()
...
class UserLoginApiView(ObtainAuthToken):
    """Handle creating user authentification token"""

    renderer_classes = api_settings.DEFAULT_RENDERER_CLASSES


class UserProfileFeedViewSet(ModelViewSet):
    """Handle creating and updating user profile fed"""

    serializer_class: ModelSerializer = serializers.ProfileFeedItemSerializer
    queryset: QuerySet = models.ProfileFeedItem.objects.all()
    authentication_classes = (TokenAuthentication,)
